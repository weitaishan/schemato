// Supported input and output formats. Add new formats here, then register a parser or renderer.
...
export type FormatId =
  ...
  | "mongoose"
  | "prisma"
  // Output side (some can also be inputs)
  | "zod"
  | "yup"
  | "joi"
  | "pydantic"
...
export interface FormatMeta {
  ...
  /** Display name */
  name: string;
  /** Short description used in tool subtitles and SEO copy */
  blurb: string;
  /** Syntax highlighting language id */
  lang: string;
  /** Default sample shown in the editor */
  sample: string;
}
...
// These two arrays define the converter matrix: 10 inputs × 15 outputs minus invalid same-format pairs.
...
/** Generate all valid (from, to) pairs. Same-format pairs are skipped. */
